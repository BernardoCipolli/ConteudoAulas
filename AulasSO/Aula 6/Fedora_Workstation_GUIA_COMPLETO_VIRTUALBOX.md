# 🎩 Fedora Workstation --- Guia Completo + Oracle VirtualBox
...
## 🧭 Visão rápida
  ...
  Item                                Resumo
  ----------------------------------- -----------------------------------
  🧬 Base                             Fedora Linux / ecossistema RPM

  🖼️ Desktop                          GNOME

  🎯 Foco                             Desktop moderno com tecnologias
                                      recentes, forte uso acadêmico e
                                      para desenvolvimento.

  📦 Pacotes                          DNF / RPM + Flatpak

  🧠 RAM da VM                        4 GB recomendado em VM

  ⚙️ CPU da VM                        2--4 vCPUs

  💽 Disco                            30--50 GB recomendado para
                                      laboratório
  -----------------------------------------------------------------------

## 📜 História e origem

Fedora é uma distribuição comunitária patrocinada pela Red Hat e
conhecida por incorporar tecnologias open source recentes. Fedora
Workstation 44 foi lançado em 28/04/2026 e usa GNOME.
...
-   Containers
-   Desktop moderno
-   Aprendizado de tecnologias Linux atuais
-   Laboratórios e programação

## 🧠 Mapa mental

``` mermaid
mindmap
  root((Fedora Workstation))
    Fundamentos
      Kernel Linux
      Processos e threads
      Memória virtual
...
-   **GNOME Software --- aplicativos**
-   **Firefox --- navegador**
-   **DNF --- pacotes**
-   **Flatpak --- apps isolados**
-   **Podman --- containers**
...
### Configuração recomendada
  ...
  Tipo/versão                         `Linux → Fedora (64-bit) ou Other Linux (64-bit), conforme a versão do VirtualBox`

  RAM                                 4 GB recomendado em VM

  Processadores                       2--4 vCPUs

  Disco                               30--50 GB recomendado para laboratório
...
3.  Digite o nome `Fedora Workstation`.
...
6.  Confira o tipo: **Linux → Fedora (64-bit) ou Other Linux (64-bit),
    conforme a versão do VirtualBox**.
...
# 9. 🚀 Instalação do Fedora Workstation
...
``` text
Use os Guest Additions do VirtualBox se precisar de recursos de integração; mantenha kernel e pacotes atualizados antes de instalar módulos adicionais.
```
...
-   [ ] Sei criar snapshot.
-   [ ] Sei explicar vantagens e limitações do Fedora Workstation.
...
-   [Fedora
    Workstation](https://www.fedoraproject.org/pt-br/workstation/)
-   [Download Fedora
    44](https://www.fedoraproject.org/pt-br/workstation/download/)
-   [Documentação](https://docs.fedoraproject.org/)
