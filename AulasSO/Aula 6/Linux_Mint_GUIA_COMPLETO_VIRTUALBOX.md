# 🌿 Linux Mint --- Guia Completo + Oracle VirtualBox
...
## 🧭 Visão rápida
  ...
  Item                                Resumo
  ----------------------------------- -----------------------------------
  🧬 Base                             Ubuntu LTS (edição principal)

  🖼️ Desktop                          Cinnamon, MATE ou Xfce

  🎯 Foco                             Desktop simples, estável e pronto
                                      para uso, popular para iniciantes.

  📦 Pacotes                          APT / dpkg + Flatpak

  🧠 RAM da VM                        2 GB pode iniciar; 4 GB recomendado
                                      para Cinnamon em VM

  ⚙️ CPU da VM                        2 vCPUs

  💽 Disco                            25--40 GB para laboratório; o
                                      sistema base ocupa cerca de 15 GB
                                      segundo o guia
  -----------------------------------------------------------------------

## 📜 História e origem

Linux Mint surgiu em 2006 com foco em desktop amigável. A versão 22.3
'Zena' é LTS, baseada na família Ubuntu Noble e suportada até abril de
2029; Cinnamon é a edição mais popular.
...
-   **Cinnamon --- desktop principal**
-   **Update Manager --- atualizações**
...
### Configuração recomendada
  ...
  RAM                                 2 GB pode iniciar; 4 GB recomendado
                                      para Cinnamon em VM
...
``` text
Instale os Guest Additions pelo menu Dispositivos do VirtualBox; reinicie após a instalação.
```
...
-   [ ] Sei criar snapshot.
-   [ ] Sei explicar vantagens e limitações do Linux Mint.
...
-   [Guia de
    instalação](https://linuxmint-installation-guide.readthedocs.io/en/latest/)
-   [Versões](https://www.linuxmint.com/download_all.php)
