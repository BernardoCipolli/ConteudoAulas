# ✨ Zorin OS 18 --- Guia Completo + Oracle VirtualBox
...
## 🧭 Visão rápida
  ...
  🖼️ Desktop                          GNOME Shell (Core/Pro) ou Xfce
                                      (Lite)

  🎯 Foco                             Desktop amigável, especialmente
                                      para usuários migrando do
                                      Windows/macOS.

  📦 Pacotes                          APT, Flatpak, Snap, .deb, AppImage;
                                      suporte opcional a apps Windows

  🧠 RAM da VM                        2 GB mínimo oficial; 4 GB
                                      recomendado em VM

  ⚙️ CPU da VM                        2 vCPUs ou mais

  💽 Disco                            Core: mínimo oficial 15 GB; use
                                      30--50 GB na VM para ter folga
  -----------------------------------------------------------------------

## 📜 História e origem

Zorin OS é uma distribuição baseada em Ubuntu criada para tornar Linux
acessível. Zorin OS 18 foi lançado em 14/10/2025; a linha 18 é baseada
em Ubuntu 24.04 LTS e recebe atualizações de segurança até 01/06/2029.

## 🎯 Onde é usado

-   Migração do Windows para Linux
-   Uso doméstico e acadêmico
-   Produtividade
-   Desenvolvimento
-   Teste de Linux em VM
...
mindmap
  root((Zorin OS 18))
    Fundamentos
      ...
      Sistema de arquivos
    Interface
      GNOME Shell (Core/Pro) ou Xfce (Lite)
      Terminal
      Configurações
    Software
      APT, Flatpak, Snap, .deb, AppImage; suporte opcional a apps Windows
      Repositórios
      Atualizações
    VirtualBox
      ISO
...
-   **Zorin Appearance --- personalização visual**
-   **Software --- instalação gráfica**
-   **LibreOffice --- escritório**
-   **Firefox --- web**
-   **Windows App Support --- compatibilidade opcional**
...
### Configuração recomendada
  ...
  RAM                                 2 GB mínimo oficial; 4 GB
                                      recomendado em VM

  Processadores                       2 vCPUs ou mais
  ...
  Vídeo                               128 MB; resolução 1024×768 ou
                                      superior durante a instalação
...
``` text
Use os Guest Additions do VirtualBox para melhor integração de tela, mouse, clipboard e pastas compartilhadas.
```
...
-   [ ] Sei criar snapshot.
-   [ ] Sei explicar vantagens e limitações do Zorin OS 18.

------------------------------------------------------------------------

# 20. 📚 Fontes oficiais

-   [Detalhes técnicos](https://zorin.com/os/details/)
-   [VirtualBox
    oficial](https://help.zorin.com/docs/getting-started/install-zorin-os-in-virtualbox/)
-   [Instalação](https://help.zorin.com/docs/getting-started/install-zorin-os/)
